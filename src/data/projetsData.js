...
export const projectsData = [
  {
    ...
    number: "1",
    info: ["React", "React Router", "Vite", "HTML", "Sass", "JavaScript"],
...
`,
  },
  {
    ...
    presentation: `Ce projet consistait à développer le site vitrine d’une architecte d’intérieur, Sophie Bluel, en mettant l’accent sur l'interactivité et la gestion dynamique des contenus. 
...
`,
  },
  {
    ...
    number: "3",
    info: ["SEO", "Débugage", "Chrome DevTools", "Lighthouse", "Schema.org"],
    presentation: `Dans ce projet, j’ai travaillé sur l’optimisation SEO et l’amélioration de l’accessibilité du site web d’une photographe : Nina Carducci. L’objectif principal était d’améliorer sa visibilité en ligne, ses performances et de garantir une expérience utilisateur inclusive.`,
    description: `
